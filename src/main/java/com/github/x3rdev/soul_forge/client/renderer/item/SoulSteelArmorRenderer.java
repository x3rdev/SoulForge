...
public class SoulSteelArmorRenderer extends GeoArmorRenderer<SoulSteelArmorItem> {
    public SoulSteelArmorRenderer() {
        ...
        addRenderLayer(new AutoGlowingGeoLayer<>(this){
            @Override
            protected RenderType getRenderType(SoulSteelArmorItem animatable) {
                return RenderType.eyes(new ResourceLocation(SoulForge.MOD_ID, "textures/item/armor/soul_steel_glowmask.png"));
            }
        });
    }
}
