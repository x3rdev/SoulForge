...
public class NergalSpawnRenderer extends GeoEntityRenderer<NergalSpawn> {
    ...
    @Override
    public @Nullable RenderType getRenderType(NergalSpawn animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
