...
public class BlockItemRegistry {
    ...
    public static final DeferredHolder<Item, BlockItem> RITUAL_ALTAR = BLOCK_ITEMS.register("ritual_altar",
            () -> new GeckoBlock(BlockRegistry.RITUAL_ALTAR.get(), new Item.Properties()));
}