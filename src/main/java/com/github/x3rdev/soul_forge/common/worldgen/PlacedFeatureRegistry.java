...
public class PlacedFeatureRegistry {
    ...
    public static final ResourceKey<PlacedFeature> SOUL_CRYSTAL_ORE_PLACED_KEY = registerKey("soul_crystal_ore");

    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        HolderGetter<ConfiguredFeature<?, ?>> configuredFeatures = context.lookup(Registries.CONFIGURED_FEATURE);

        context.register(SOUL_CRYSTAL_ORE_PLACED_KEY, new PlacedFeature(
                configuredFeatures.getOrThrow(ConfiguredFeatureRegistry.SOUL_CRYSTAL_ORE),
